...
public class Villa extends Facility{
    ...
    public Villa(String idService,String nameService, int areaUse, int rentalCost, int maxPerson, String typeRental, String roomStandard, double areaPool, int numberOfFloor) {
